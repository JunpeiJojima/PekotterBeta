...
<body class="loginOk">
	...
	<div class="loginOk-content wrapper">
			...
			<span class="mgr-15"><a class="button2"
				href="${pageContext.request.contextPath}/Main"> つぶやき画面へGO! </a></span> <a class="button2"
				href="${pageContext.request.contextPath}/WelcomServlet">トップへ戻るぺこ</a>
		</div>
		<!-- /.home-content -->
	
	<!-- <a href="${pageContext.request.contextPath}/Main">つぶやき画面へGOぺこ！</a> -->
	<!-- <a href="${pageContext.request.contextPath}/WelcomServlet">トップへ戻るぺこ</a> -->
